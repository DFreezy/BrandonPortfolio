  ...
  return (
    <div className="bg-gray-100 min-h-screen px-50">
      ...
      <div
        ...
        style={{ backgroundImage: 'url(/R.jfif)', minHeight: 'calc(100vh - 10rem)' }}
      >
        <div className="">
          <img
            src="image.jfif"
            alt="Profile"
            className="w-32 lg:w-40 rounded-full shadow-lg mx-auto lg:mx-10"
          />
      ...
      {/* Experience Cards */}
      <div className="flex flex-wrap justify-center gap-6 px-10 border-black">
      ...
      <div className="px-10 py-10 text-center bg-gray-200">
        ...
        <p className="mt-4 text-gray-600 max-w-3xl mx-auto" id="resume">
